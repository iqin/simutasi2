    ...
    <body>
        ...
        <div id="chatbox-container" style="display: none;">
            ...
            <p class="saran-ajakan">
                ...
                <input type="hidden" id="email-guru" value="<?= $email ?? '' ?>">
        ...
        <script>
            ...
            // Validasi: email dicek tapi tidak perlu trim karena dari hidden input
            if (!email || saranText.trim() === '') {
                let message = '';
                if (!email) message = 'Pengiriman saran tidak berhasil, Email tidak ditemukan!.';
                else if (saranText.trim() === '') message = 'Saran wajib diisi!';
